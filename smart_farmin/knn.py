...
def train_crops():
    # try:
        ...
        training_file = 'data/data/crop_value_ds_new.csv'
...
def predict_crop(path):
    ...
    try:
        ...
        # sc=accuracy_score(training_set,test_set)
        # print(sc)

        # from sklearn.metrics import confusion_matrix
        # cc=confusion_matrix(training_set,test_set)
        # print(cc)
...
a=newpredict_farmer_cropss(['49', '14', '8.65', '5.89', '1.4', '0.9', '1.12', '0.4', '1.18', '0.43', '28', '18'])
print("sssssssss",a)